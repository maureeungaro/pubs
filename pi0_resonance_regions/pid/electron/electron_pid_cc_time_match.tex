...
\begin{figure}[ht]
  \centering
		\includegraphics[width=0.46\textwidth]{img/slice-03_cut-03-tim_sector-1.png}
		\includegraphics[width=0.46\textwidth]{img/slice-08_cut-03-tim_sector-1.png}
		\includegraphics[width=0.46\textwidth]{img/slice-12_cut-03-tim_sector-1.png}
		\includegraphics[width=0.46\textwidth]{img/slice-15_cut-03-tim_sector-1.png}
...
\begin{figure}[ht]
  \centering
		\includegraphics[width=0.98\textwidth]{img/cut-03-timc_sector-1.png}
		\caption{CC time matching. The difference $\Delta T$ between the track time recorded
               at a CC tube ($T_{CC}$) and corresponding time recorded on the TOF ($T_{SC}$),
               corrected for the path length from the CC to the TOF ($|\vec{R_{CC}}-\vec{R_{SC}}|/c$),
